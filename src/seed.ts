...
const humanItems: HumanItem[] = [
  {
    ...
    summary: "기술적으로는 양쪽 모두 가능합니다. 그러나 이 선택은 커뮤니티를 확장하는 권한 철학을 바꿉니다.",
  ...
  },
  {
    ...
    summary: "장소 입력 뒤 지도 서비스로 이동해 시간을 확인하는 행동이 반복되었습니다.",
    rationale: "테스트 사용자 흐름에서 반복된 행동을 관찰했습니다. 예상 가치가 높지만 제품 방향 변경 가능성이 있어 제안으로 올립니다.",
    blockingScope: [],
  ...
  },
  {
    ...
    summary: "Acceptance check 통과. 실제 외부 사용자에게 영향을 주는 배포이므로 승인이 필요합니다.",
