...
function compactState(state: AppState, projectId: string, autonomy: AutonomyProjectState): Record<string, unknown> | undefined {
  ...
  return {
    ...
    project: { status: project.status, budgetRemaining: "unlimited", spendObserved: project.budgetSpent, productionBlocked: project.settings.productionBlocked, networkPolicy: project.settings.networkPolicy },
